...
mpData = ut.readData("mp_data", "dynamic_pred")
stratPopData = ut.readData("strat_pop_data", "dynamic_pred")
pqrsData = ut.readData("pqrs_data", "dynamic_pred")
stratFitData = gs.calcStratFitData(stratData, pqrsData, F=0.3414)
stratFitMpData = pd.concat([stratFitData.loc[stratPopData.index], mpData.loc[stratPopData.index, 'M1':'M8']], axis=1)
ut.writeData(stratFitMpData, "strat_fit_mp_data.best")
