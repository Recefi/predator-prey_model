...
if __name__ == "__main__":
    ...
    strat = stratByParam_de(a_j=0.0025, b_j=0.0000063, g_j=0.00353, d_j=0.000019,
                                a_a=0.065, b_a=0.000022, g_a=0.0224, d_a=0.000015)
    print(strat.x, strat.fun)
    strat = stratByParam_shgo(a_j=0.0025, b_j=0.0000063, g_j=0.00353, d_j=0.000019,
                                a_a=0.065, b_a=0.000022, g_a=0.0224, d_a=0.000015)
    print(strat.x, strat.fun)
    # [-34.56, -3.31, -83.21, -51.55] ([-34.55607081  -3.31162373 -83.20792447 -51.5526795 ])
...
# print(_FLim, err)
# TODO: попробовать подогнать F* к 1, мб результаты улучшаться
